...
export default function Typewriter({
  ...
  return (
    <div className="typewriter">
      <span className='mukta-bold text-transparent bg-clip-text bg-gradient-to-b text-3xl from-[#6EACDA] via-[#6EACDA] to-[#fff]'>{constantText}</span>
      <span className="typed-text mukta-bold text-transparent bg-clip-text bg-gradient-to-b text-3xl from-[#6EACDA] via-[#6EACDA] to-[#fff] mx-2">{currentText}</span>
      <span className="cursor text-[#6EACDA] text-3xl">|</span>
    </div>
  );
}
