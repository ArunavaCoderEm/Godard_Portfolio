  ...
  return (
    <>
        <BackgroundBeamsWithCollision>
          <div className="grid grid-cols-1 gap-y-10 mt-20 mukta relative h-screen">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 p-3 gap-4">
              <div className="flex mt-5 justify-center items-center p-3">
                ...
                <h1
                  ...
                  className="text-xl absolute font-thin cursor-pointer hidden tracking-tight lg:flex h-[75vh] py-1 mb-1 right-0 text-[#6EACDA] mukta vertical-text"
                >
                  SCROLL DOWN
                </h1>
              </div>
