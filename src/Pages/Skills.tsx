...
const Skills = ():React.ReactNode => {
  ...
  return (
   <>
    <button className="flex shaw items-center mt-24 w-32 absolute right-0 left-0 mx-auto backdrop-blur-sm bg-black/60 text-white font-semibold px-4 py-1 rounded-full shadow-lg sha focus:outline-none">
        <span className="mr-2">✨</span> Skills <span className="ml-2">✨</span>
    </button>
    <div className='grid lg:grid-cols-2 mt-40 sm:grid-cols-1'>
