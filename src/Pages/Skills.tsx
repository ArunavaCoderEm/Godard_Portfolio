...
const Skills = ():React.ReactNode => {
  ...
  return (
   <>
    <button className="flex shaw items-center my-5 w-32 absolute right-0 left-0 mx-auto backdrop-blur-sm bg-black/60 text-white font-semibold px-4 py-1 rounded-full shadow-lg sha focus:outline-none">
        <span className="mr-2">✨</span> Skills <span className="ml-2">✨</span>
    </button>
    <div className='grid lg:grid-cols-2 mt-20 sm:grid-cols-1'>
        <div className='p-5 flex flex-col items-center'>
            ...
            className="relative mx-1 inline-flex items-center justify-start  px-5 py-3 overflow-hidden font-bold rounded-full group">
                ...
                <span className="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-gray-900">My Skills</span>
            ...
            className="relative mx-1 inline-flex items-center justify-start  px-5 py-3 overflow-hidden font-bold rounded-full group">
                ...
                <span className="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-gray-900">My Tools</span>
